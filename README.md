...
TextLabel_2.Text = "Enter Your Key to confirm that you want to use this hub"
...
TextBox.FocusLost:Connect(function(entered)
	if entered == true then
		if TextBox.Text == "XOoFnVQOyaqbz23r" then
			...
			Tween2.Completed:Connect(function()
				...
				wait(3)
				if game.PlaceId == 8645723106 then
					ScreenGui:Destroy()
			...
			game.Players.LocalPlayer:Kick("You can't use the script before confimation")
		end
	end
end)
